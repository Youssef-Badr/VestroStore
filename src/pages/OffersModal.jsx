        ...
        {isOpen && (
          <>
            ...
            <motion.div 
              ...
              className={`fixed top-0 ${isRTL ? "left-0" : "right-0"} h-full w-full max-w-md z-[70] shadow-2xl p-8 overflow-y-auto ${darkMode ? "bg-[#0a0a0a] text-white" : "bg-white text-black"}`}
            >
              <div className="flex justify-between items-center mb-2 border-b border-zinc-800 pb-2 pt-24">
                ...
                <button onClick={onClose} className="p-2 hover:bg-[#86FE05] hover:text-black rounded-full transition-all"><FiX size={24} /></button>
              </div>
...
<motion.button
  ...
  className={`
    ...
    ${darkMode 
      ? "bg-[#86FE05]/5 border-[#86FE05]/20 hover:bg-[#86FE05] hover:text-black" 
      : "bg-black text-white border-black hover:bg-[#86FE05] hover:text-black"}
  `}
>
  {/* النص */}
...
<AnimatePresence>
    ...
    <>
      ...
      <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
        <motion.div
          ...
          className={`w-full max-w-md max-h-[90vh] overflow-y-auto rounded-[2rem] p-5 md:p-6 shadow-2xl ${
  ...
  <p className="text-[#6dcd07] font-bold text-base md:text-lg">
    {isRTL
  ...
  <p className="bg-[#86FE05]/10 border border-[#86FE05]/30 p-3 rounded-xl">
    {isRTL
  ...
  <p className="text-[#65bd08] font-bold">
    {isRTL
  ...
  <p className="text-[#6ecf06] font-bold text-base md:text-lg">
    {isRTL
      ...
      : "💰 The smarter you shop, the more you save!"}
          ...
          <button
            onClick={() => setShowInfo(false)}
            className="mt-6 w-full py-3 rounded-xl bg-[#86FE05] text-black font-bold"
          >
