...
export default function Footer() {
  ...
  const handleDragEnd = (event, info) => {
    ...
    let newY = Math.max(
      margin,
      Math.min(info.point.y, screenHeight - boxHeight),
    );

    // 📌 Snap يمين أو شمال (زي iPhone)
    const snapX =
      newX > screenWidth / 2 ? screenWidth - boxWidth - margin : margin;
    ...
    features: [
      {
        ...
        desc: isRTL ? "خلال 2-4 أيام عمل" : "2-4 business days",
        icon: <FiTruck size={28} />,
      },
      {
        title: isRTL ? "جودة عالية" : "Premium Quality",
        desc: isRTL ? "أفضل الخامات العصرية" : "Best modern materials",
        icon: <FiShield size={28} />,
      },
      {
        title: isRTL ? "معاينة وإرجاع" : "Inspect & Return",
        desc: isRTL ? "افحص طلبك عند الاستلام" : "Check upon delivery",
        icon: <FiRefreshCw size={28} />,
      },
    ],
    aboutDesc: isRTL
      ? "متجر متخصص في توفير مجموعة مميزة من الملابس العصرية الرياضية والكاجوال بجودة تنافسية."
      : "Specialized store providing a unique collection of modern sports and casual wear.",
    rights: isRTL
      ? "© 2026 فيسترو ستور. جميع الحقوق محفوظة."
      : "© 2026 VESTRO STORE. All Rights Reserved.",
  };
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-20">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
            ...
            <div className="md:col-span-5 space-y-8">
              ...
              <p
                className={`text-base leading-relaxed max-w-md ${darkMode ? "text-gray-300" : "text-black font-semibold"}`}
              >
                {t.aboutDesc}
              </p>
              ...
              <button
                ...
                className="flex items-center gap-2 text-black dark:text-white text-xl font-black uppercase               hover:scale-105 transition-transform bg-red-700 px-4 py-2 rounded-full"
              >
                <FiInfo size={18} />{" "}
                {isRTL ? "سياسات المتجر" : "Store Policies"}
              </button>
              ...
              <div className="flex gap-5">
                {[
                  {
                    icon: <FaFacebookF />,
                    link: "https://www.facebook.com/share/1E4b9xJXs2/?mibextid=wwXIfr",
                    color: "hover:bg-red-700",
                  },
                  {
                    icon: <FaInstagram />,
                    link: "https://www.instagram.com/vestroeg?igsh=MXZpaHVtcm05bjUyeQ%3D%3D&utm_source=qr",
                    color:
                      "hover:bg-gradient-to-tr from-[#F58529] via-[#DD2A7B] to-[#8134AF]",
                  },
                  {
                    icon: <FaTiktok />,
                    link: "https://www.tiktok.com/@stokecity58113?_r=1&_t=ZS-95FzIbdfEkm",
                    color: "hover:bg-red-700",
                  },
                ].map((social, i) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all ${darkMode ? "border-white/10 bg-white/5" : "border-black bg-white"} ${social.color} hover:text-white hover:-translate-y-2`}
                  >
                    {social.icon}
                  </a>
                ))}
            ...
            <div className="md:col-span-3 space-y-10">
              <div className="space-y-5">
                <h3 className="text-lg font-black uppercase  text-black dark:text-white   ">
                  {isRTL ? "طرق الدفع" : "Payments"}
                </h3>
                <div className="flex flex-wrap gap-5 items-center">
                  <FaCcVisa
                    size={40}
                    className="text-[#1A1F71] bg-white rounded-sm"
                  />
                  <FaCcMastercard
                    size={40}
                    className="text-[#EB001B] bg-white rounded-sm"
                  />
                  <div
                    className={`px-3 py-1.5 border-2 rounded-lg text-[10px] font-black ${darkMode ? "border-white text-white" : "border-black text-black"}`}
                  >
                    PAYMOB
                  </div>
                  <div
                    className={`flex items-center gap-2 px-3 py-1.5 border-2 rounded-lg text-[10px] font-black ${darkMode ? "border-white text-white bg-[#86FE05]/5" : "border-black text-black bg-gray-50"}`}
                  >
          ...
          <div
            className={`mt-24 pt-10 border-t-2 flex flex-col md:flex-row justify-between items-center gap-6 text-xs font-black uppercase               ${darkMode ? "border-white/5 text-gray-500" : "border-gray-200 text-black"}`}
          >
            <p>{t.rights}</p>
