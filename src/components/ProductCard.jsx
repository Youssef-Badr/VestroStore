    ...
    />
        ...
        {product.salePercentage > 0 && (
          <>
            <div className="absolute top-4 left-4 z-20">
              <div className="bg-slate-900/90 dark:bg-[#86FE05]/20 backdrop-blur-md border border-[#86FE05]/20 dark:border-[#86FE05]/40 dark:text-[#86FE05] text-white text-[10px] sm:text-[11px] font-black px-3 py-1.5 rounded-full italic shadow-xl">
                -{product.salePercentage}%
              </div>
            </div>
            <div className="absolute top-4 right-4 z-20">
              <div className="bg-slate-900/90 dark:bg-[#86FE05]/20 backdrop-blur-md border border-[#86FE05]/20 dark:border-[#86FE05]/40 dark:text-[#86FE05] text-white text-[10px] sm:text-[11px] font-black px-3 py-1.5 rounded-full italic shadow-xl uppercase tracking-wider">
                {isRTL ? "تخفيض" : "SALE"}
              </div>
            </div>
          </>
        ...
        {!isSoldOut && (
          <button
            ...
            className="absolute bottom-6 right-6 w-12 h-12 sm:w-14 sm:h-14 bg-white dark:bg-[#86FE05] text-black rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-2xl translate-y-20 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 z-10 hover:scale-110"
          >
      ...
      <div className="pt-5 px-1 flex flex-col items-center text-center gap-3">
        ...
        {!isSoldOut && (
          <button
            ...
            className="w-full mt-2 bg-slate-900 dark:bg-[#86FE05] text-white dark:text-black py-4 rounded-[1.2rem] text-[11px] font-black uppercase italic tracking-[0.2em] flex items-center justify-center gap-2 hover:bg-black dark:hover:bg-white transition-all shadow-lg active:scale-95"
          >
